...
import Ragui from "./Ragui.js"; // Add this import
...
const ProjectPage = () => {
  ...
  useEffect(() => {
    ...
    const updateLastAccess = () => {
      axios
        .post(
          `${process.env.REACT_APP_BACKEND_URL}/projects/${projectId}/last-access`,
          { withCredentials: true }
        )
  ...
  const renderActiveComponent = () => {
    switch (activeTab) {
      ...
      case "rag":
        return <Ragui projectId={projectId} />;
